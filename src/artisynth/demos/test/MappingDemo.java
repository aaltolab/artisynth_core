...
public class MappingDemo extends RootModel {
   ...
   public static class DrawMappings extends RenderableComponentBase {
      ...
      boolean myNormalMapEnabled = false;
      boolean myBumpMapEnabled = false;
      ...
      String getDataFolder() {
         return "/Users/kieran/develop/artisynth/artisynth_projects/src/artisynth/models/kieran/dodecaheadron/data/april_tags/300ppi/";
      }

      public void createTextureProps() {
         // create texture mapping
         myTextureProps = new ColorMapProps ();
         myTextureProps.setFileName (getDataFolder()+"tag_0@300ppi.jpg");
      ...
      public void createNormalProps() {
         ...
         myNormalProps.setFileName (getDataFolder()+"tag_0@300ppi.jpg");
      ...
      public void createBumpProps() {
         ...
         myBumpProps.setFileName (getDataFolder()+"tag_0@300ppi.jpg");
      ...
      public void prerender (RenderList list) {
         ...
         if (myRenderObj == null) {
            ...
            robj.vertex (-2.625f, -2.625f, 0f);
            robj.addTextureCoord (1, 0);
            robj.vertex ( 2.625f, -2.625f, 0);
      ...
      public void render (Renderer renderer, int flags) {
         ...
         renderer.setColor (Color.WHITE);                    // base color
