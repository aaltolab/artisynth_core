...
public class MappingTest extends MeshTestBase {
   ...
   static String datafolder = "/Users/kieran/develop/artisynth/artisynth_projects/src/artisynth/models/kieran/dodecaheadron/data/april_tags/300ppi/";

   FixedMeshBody createMesh (MechModel mech, double z) {
      PolygonalMesh mesh = 
         MeshFactory.createRectangle (5.25, 5.25, 10, 10, /*texture=*/true);
   ...
   public ColorMapProps createTextureProps() {
      ...
      props.setFileName (datafolder+"tag_0@300ppi.jpg");
